...
const MegaLabView: React.FC = () => {
  ...
  const tools: LabTool[] = [
    ...
    { 
      ...
      realWorld: "Analisis teknikal trading buat nentuin entry point.", 
      simType: "quadratic", 
      inputs: [{ label: 'Base (a)', key: 'a', def: 100, unit: '$' }, { label: 'Growth (b)', key: 'b', def: 10, unit: '$' }],
      calc: (v) => `Projected: $${(v.a + v.b * 10).toFixed(2)}`
    }
  ];
